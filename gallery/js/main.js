  ...
  ROOMS.forEach((r, i) => {
    ...
    li.innerHTML = `
      <button class="vitrine" type="button">
        <div class="shot"><img src="gallery/shots/${r.name}.jpg" width="2160" height="1350"
    ...
    btn.addEventListener('click', () => openRoom(r, no, li));
    frag.appendChild(li);
    wraps.push(li);
  });
